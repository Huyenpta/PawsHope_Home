        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/adopt" className="hover:text-white transition-colors">Quy trình nhận nuôi</Link></li>
              <li><Link to="/volunteers" className="hover:text-white transition-colors">Danh sách tình nguyện viên</Link></li>
              <li><Link to="/transparency" className="hover:text-white transition-colors">Báo cáo minh bạch</Link></li>
              <li><Link to="/rescue" className="hover:text-white transition-colors">Câu chuyện cứu hộ</Link></li>
              <li><Link to="/rescue/report" className="hover:text-[#f6931d] font-semibold transition-colors">🆘 Báo cáo cứu hộ</Link></li>
            </ul>
          </div>
